...
const Hr01Page = () => { // สามารถเปลี่ยนชื่อเป็น ProvincePage หรือ Hr114Page เพื่อความชัดเจน
  ...
  const labelText = useMemo(() => {
    ...
    const label = intl.formatMessage({ id: 'sidebar.hr01.13' }); // สมมติว่าใช้ id นี้
    const words = label.split("HR113 "); // ตัวอย่างการตัด HR113 ออก
  ...
  return (
    <AppCard
      ...
      title={<IntlMessages id="sidebar.hr01.13" />}
      action={
        <Button
          variant="outlined"
          color="primary"
