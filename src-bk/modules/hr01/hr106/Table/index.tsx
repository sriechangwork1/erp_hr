...
const DataTable = ({ data, onView, onEdit, onDelete }: DataTableProps) => {
  ...
  const labelText = useMemo(() => {
    const label = intl.formatMessage({ id: 'sidebar.hr01.06' }); // เปลี่ยนเป็น hr01.06
    const words = label.split("HR106 "); // เปลี่ยนเป็น HR106
  ...
  const columns: readonly Column[] = useMemo(
    () => [
      ...
      { id: 'position_level_name', label: 'ชื่อ' + labelText, minWidth: 200, sortable: true },
