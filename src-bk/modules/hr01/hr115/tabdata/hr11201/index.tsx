...
const Hr01Page = () => { 
  ...
  const labelText = useMemo(() => {
    const label = intl.formatMessage({ id: 'sidebar.hr01.1501' }); // สมมติว่าใช้ id นี้
    const words = label.split("HR11201 "); // ตัวอย่างการตัด HR115 ออก
  ...
  return (
    <AppCard
      ...
      title={<IntlMessages id="sidebar.hr01.1501" />}
      action={
        <Button
          variant="outlined"
          color="primary"
