...
// --- กำหนดประเภทข้อมูลสำหรับแต่ละแถวในตาราง (คงโครงสร้างเดิมของ hr108) ---
export interface Data {
  id: number;
  support_position_name: string;
  create_at: string;
  update_at: string;
  officer_id: string;
  [key: string]: any;
...
// ข้อมูลจำลองเริ่มต้นสำหรับตาราง (ย้ายมาจาก hr108/table/index.tsx)
const initialAllRows: Data[] = [
  {
    id: 1,
    support_position_name: 'ปฏิบัติงาน',
  ...
  {
    id: 2,
    support_position_name: 'ชำนาญงาน',
    create_at: '24 พฤษภาคม 2567',
    update_at: '24 พฤษภาคม 2567',
    officer_id: 'นายเจ้าหน้าที่ บุคคล'
  },
  ...
  {
    id: 4,
    support_position_name: 'ปฏิบัติการ',
    create_at: '24 พฤษภาคม 2567',
    update_at: '24 พฤษภาคม 2567',
    officer_id: 'นายเจ้าหน้าที่ บุคคล'
  },
  {
    id: 5,
    support_position_name: 'ชำนาญการ',
    create_at: '24 พฤษภาคม 2567',
    update_at: '24 พฤษภาคม 2567',
    officer_id: 'นายเจ้าหน้าที่ บุคคล'
  },
  {
    id: 6,
    support_position_name: 'ชำนาญการพิเศษ',
    create_at: '24 พฤษภาคม 2567',
    update_at: '24 พฤษภาคม 2567',
    officer_id: 'นายเจ้าหน้าที่ บุคคล'
  },
  {
    id: 7,
    support_position_name: 'เชี่ยวชาญ',
    create_at: '24 พฤษภาคม 2567',
    update_at: '24 พฤษภาคม 2567',
    officer_id: 'นายเจ้าหน้าที่ บุคคล'
  },
  {
    id: 8,
    support_position_name: 'เชี่ยวชาญพิเศษ',
    create_at: '24 พฤษภาคม 2567',
    update_at: '24 พฤษภาคม 2567',
    officer_id: 'นายเจ้าหน้าที่ บุคคล'
  }
...
const Hr01Page = () => {
  ...
  // ฟังก์ชันสำหรับดึงข้อความ label จาก intl และจัดการกรณีที่ไม่พบ 'HR108 '
  const labelText = useMemo(() => {
    const label = intl.formatMessage({ id: 'sidebar.hr01.08' });
    const words = label.split("HR108 ");
  ...
  const validateData = () => {
    ...
    if (!currentData?.support_position_name) {
      newErrors.support_position_name = 'กรุณากรอกข้อมูลชื่อตำแหน่งประเภทสนับสนุน';
    }
    setErrors(newErrors);
  ...
  return (
    <AppCard
      ...
      title={<IntlMessages id="sidebar.hr01.08" />}
      action={
        <Button
          variant="outlined"
          color="primary"
      ...
      >
        <Box>
          ...
          <TextField
            ...
            margin="normal"
            size="small"
            value={currentData?.support_position_name || ''}
            name="support_position_name"
            onChange={handleInputChange}
            disabled={dialogMode === 'view'}
            error={!!errors.support_position_name}
            helperText={errors.support_position_name}
          />
          <TextField
            fullWidth
