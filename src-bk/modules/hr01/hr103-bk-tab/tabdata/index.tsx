...
import Hr10304 from './hr10304';
import Hr10305 from './hr10305';
import Hr10306 from './hr10306';
...
const Hr103Setting = () => {
  ...
  return (
    <Box>
      <IntlMessages id="sidebar.hr01.03" />
      <Tabs
        value={value}
      ...
      <Tab
        className="crMuiTab"
        label={<Chip label="ตำแหน่งที่สูงขื้นสายสนับสนุน" />}
        {...a11yProps(4)}
      />
      <Tab
        className="crMuiTab"
