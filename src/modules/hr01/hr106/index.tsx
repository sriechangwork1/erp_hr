...
// --- กำหนดประเภทข้อมูลสำหรับแต่ละแถวในตาราง (คงโครงสร้างเดิมของ hr106) ---
...
// ข้อมูลจำลองเริ่มต้นสำหรับตาราง (ย้ายมาจาก hr106/table/index.tsx)
const initialAllRows: Data[] = [
  {
    id: 1,
    position_level_name: 'ปฏิบัติการ',
  ...
  {
    id: 5,
    position_level_name: 'เชี่ยวชาญพิเศษ',
    create_at: '24 พฤษภาคม 2567',
    update_at: '24 พฤษภาคม 2567',
    officer_id: 'นายเจ้าหน้าที่ บุคคล'
  },
  {
    id: 6,
    position_level_name: 'ทรงคุณวุฒิ',
    create_at: '24 พฤษภาคม 2567',
    update_at: '24 พฤษภาคม 2567',
    officer_id: 'นายเจ้าหน้าที่ บุคคล'
  }
...
const Hr01Page = () => {
  ...
  // ฟังก์ชันสำหรับดึงข้อความ label จาก intl และจัดการกรณีที่ไม่พบ 'HR106 '
  ...
  const validateData = () => {
    ...
    if (!currentData?.position_level_name) {
      newErrors.position_level_name = 'กรุณากรอกข้อมูลชื่อระดับตำแหน่ง';
    }
    setErrors(newErrors);
      ...
      >
        <Box>
          ...
          <TextField
            ...
            margin="normal"
            size="small"
            value={currentData?.position_level_name || ''}
            name="position_level_name"
            onChange={handleInputChange}
            disabled={dialogMode === 'view'}
            error={!!errors.position_level_name}
            helperText={errors.position_level_name}
          />
          <TextField
            fullWidth
