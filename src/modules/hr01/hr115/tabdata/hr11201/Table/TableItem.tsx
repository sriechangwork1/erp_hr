  ...
  return (
    <TableRow hover key={data.id} className="item-hover">
      ...
      <TableCellWrapper align="left">
        {isLoading ? <Skeleton width={150} /> : data.nation_name_th}
      </TableCellWrapper>
      <TableCellWrapper align="left">
        {isLoading ? <Skeleton width={150} /> : data.nation_name_en}
      </TableCellWrapper>
      <TableCellWrapper align="center">
        {isLoading ? <Skeleton width={100} /> : data.nation_abb_name}
      </TableCellWrapper>
      <TableCellWrapper align="center">
