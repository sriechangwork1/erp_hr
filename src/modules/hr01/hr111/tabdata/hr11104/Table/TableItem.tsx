...
// นำเข้า Data interface จากไฟล์หลักของ hr11104
  ...
  return (
    <TableRow hover key={data.id} className="item-hover">
      ...
      <TableCellWrapper align="left">
        {isLoading ? <Skeleton width={150} /> : data.country_name_th}
      </TableCellWrapper>
      <TableCellWrapper align="left">
        {isLoading ? <Skeleton width={150} /> : data.country_name_en}
      </TableCellWrapper>
      <TableCellWrapper align="center">
        {isLoading ? <Skeleton width={100} /> : data.country_abb_name}
      </TableCellWrapper>
      <TableCellWrapper align="center">
