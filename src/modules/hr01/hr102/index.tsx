...
// --- กำหนดประเภทข้อมูลสำหรับแต่ละแถวในตาราง (คงโครงสร้างเดิมของ hr102) ---
...
// ข้อมูลจำลองเริ่มต้นสำหรับตาราง (ย้ายมาจาก hr102/table/index.tsx)
const initialAllRows: Data[] = [
  ...
  {
    id: 3,
    staff_type_name: 'พนักงานมหาวิทยาลัย',
    create_at: '24 พฤษภาคม 2567',
    update_at: '24 พฤษภาคม 2567',
    officer_id: 'นายเจ้าหน้าที่ บุคคล'
  },
  ...
  {
    id: 5,
    staff_type_name: 'ลูกจ้างชั่วคราว',
    create_at: '24 พฤษภาคม 2567',
    update_at: '24 พฤษภาคม 2567',
    officer_id: 'นายเจ้าหน้าที่ บุคคล'
  },
  {
    id: 6,
    staff_type_name: 'พนักงานภายใต้สัญญาจ้าง',
    create_at: '24 พฤษภาคม 2567',
    update_at: '24 พฤษภาคม 2567',
    officer_id: 'นายเจ้าหน้าที่ บุคคล'
  }
...
const Hr01Page = () => {
  ...
  // ฟังก์ชันสำหรับดึงข้อความ label จาก intl และจัดการกรณีที่ไม่พบ 'HR102 '
  const labelText = useMemo(() => {
    const label = intl.formatMessage({ id: 'sidebar.hr01.02' });
    const words = label.split("HR102 ");
    return words.length > 1 ? words[1] : label; // ถ้าไม่มี HR102 ให้ใช้ label ทั้งหมด
  }, [intl]);
  ...
  const validateData = () => {
    ...
    if (!currentData?.staff_type_name) {
      newErrors.staff_type_name = 'กรุณากรอกข้อมูลประเภทบุคลากร';
    }
    setErrors(newErrors);
      ...
      >
        <Box>
          ...
          <TextField
            ...
            margin="normal"
            size="small"
            value={currentData?.staff_type_name || ''}
            name="staff_type_name"
            onChange={handleInputChange}
            disabled={dialogMode === 'view'}
            error={!!errors.staff_type_name}
            helperText={errors.staff_type_name}
          />
          <TextField
            fullWidth
