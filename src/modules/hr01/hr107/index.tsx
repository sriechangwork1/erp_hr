...
// --- กำหนดประเภทข้อมูลสำหรับแต่ละแถวในตาราง (คงโครงสร้างเดิมของ hr107) ---
...
// ข้อมูลจำลองเริ่มต้นสำหรับตาราง (ย้ายมาจาก hr107/table/index.tsx)
const initialAllRows: Data[] = [
  ...
  {
    id: 5,
    academic_position_name: 'อาจารย์วิจัย',
    create_at: '24 พฤษภาคม 2567',
    update_at: '24 พฤษภาคม 2567',
    officer_id: 'นายเจ้าหน้าที่ บุคคล'
  },
  {
    id: 6,
    academic_position_name: 'ศาสตราจารย์อาคันตุกะ',
    create_at: '24 พฤษภาคม 2567',
    update_at: '24 พฤษภาคม 2567',
    officer_id: 'นายเจ้าหน้าที่ บุคคล'
  }
...
const Hr01Page = () => {
  ...
  // ฟังก์ชันสำหรับดึงข้อความ label จาก intl และจัดการกรณีที่ไม่พบ 'HR107 '
  ...
  const validateData = () => {
    ...
    if (!currentData?.academic_position_name) {
      newErrors.academic_position_name = 'กรุณากรอกข้อมูลชื่อตำแหน่งทางวิชาการ';
    }
    setErrors(newErrors);
  ...
  return (
    <AppCard
      ...
      title={<IntlMessages id="sidebar.hr01.07" />}
      action={
        <Button
          variant="outlined"
          color="primary"
      ...
      >
        <Box>
          ...
          <TextField
            ...
            margin="normal"
            size="small"
            value={currentData?.academic_position_name || ''}
            name="academic_position_name"
            onChange={handleInputChange}
            disabled={dialogMode === 'view'}
            error={!!errors.academic_position_name}
            helperText={errors.academic_position_name}
          />
          <TextField
            fullWidth
