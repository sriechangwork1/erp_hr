  ...
  return (
    <TableRow hover key={data.id} className="item-hover">
      ...
      <TableCellWrapper align="left">
        {isLoading ? <Skeleton width={150} /> : data.job_title_name}
      </TableCellWrapper>
      <TableCellWrapper align="left">
        {isLoading ? <Skeleton width={100} /> : data.abbreviation}
      </TableCellWrapper>
      <TableCellWrapper align="left">
        {isLoading ? <Skeleton width={100} /> : data.work_group}
      </TableCellWrapper>
