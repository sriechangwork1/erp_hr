...
// --- กำหนดประเภทข้อมูลสำหรับแต่ละแถวในตารางสำหรับข้อมูลกรอบอัตรากำลัง ---
...
const Hr03Page = () => {
  ...
  const [currentData, setCurrentData] = React.useState<ManpowerFrameworkData | null>(null);
  const [tableData, setTableData] = React.useState<ManpowerFrameworkData[]>(initialManpowerFrameworkRows);
