...
import { InvoiceSettingType, InvoiceType, ClientType, InvoiceItemType } from '@crema/types/models/invoice';
...
const AddInvoice = ({ selectedInv, totalCount, clientsList, invoiceSettings, onSave }: AddInvoiceProps) => {
