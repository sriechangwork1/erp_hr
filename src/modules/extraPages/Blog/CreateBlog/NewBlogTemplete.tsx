...
import { BlogDetailContentType, MetaType, RecentPostType } from '@crema/types/models/extrapages/Blog';

export const CreateNewBlog = (data: Partial<BlogDetailContentType & RecentPostType & MetaType>) => {
  return {
    id: data.id,
    blogDetailHeader: [
      {
