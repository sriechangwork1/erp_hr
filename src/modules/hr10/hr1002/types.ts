...
export interface StaffDataRaw {
  ...
  // เพิ่มเติมสำหรับรายงาน
  salary_amount?: number; // อัตราเงินเดือน (จำลอง)
  employment_status?: 'ปกติ' | 'ลาออก' | 'เกษียณ' | 'พักงาน'; // สถานภาพการทำงาน (จำลอง)
  education_level?: 'ต่ำกว่าปริญญาตรี' | 'ปริญญาตรี' | 'ปริญญาโท' | 'ปริญญาเอก'; // ระดับการศึกษา (จำลอง)
}
...
export interface StaffDetailByFaculty {
  ...
  // เพิ่มเติมสำหรับรายงาน
  salaryAmount?: number;
  employmentStatus?: 'ปกติ' | 'ลาออก' | 'เกษียณ' | 'พักงาน';
  educationLevel?: 'ต่ำกว่าปริญญาตรี' | 'ปริญญาตรี' | 'ปริญญาโท' | 'ปริญญาเอก';
}
